...
class FeatureSearch:
    ...
    def __init__(
        ...
        filter: Optional[GenericProperties] = None,
    ):
        """
    ...
    def filter(self, filter: GenericProperties) -> FeatureSearch:
        """
        Create a new FeatureSearch instance that downselects to features that
        ...
        Parameters
        ----------
        filter: descarteslabs.common.GenericProperties
            AOI used to filter features by intersection
...
class Table:
    ...
    def features(
        ...
        filter: Optional[GenericProperties]
